...
def main():
    ...
    if config['use_trigger_words']:
        model_file = os.path.join(pwd, 'pkl', 'bilstm_attr_model_tw.h5')
    # model_file = None
    train_X, train_y = generate_x_y(train_datalist, myword2vecpkl, max_words, use_trigger_words=config['use_trigger_words'])
    test_X, test_y = generate_x_y(test_datalist, myword2vecpkl, max_words, use_trigger_words=config['use_trigger_words'])
